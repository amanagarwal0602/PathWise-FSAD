    ...
    CommandLineRunner initAllAccounts(UserRepository userRepository) {
        return args -> {
            ...
            // ── 1. ADMIN ──
            {
                ...
                System.out.println("  [OK] ADMIN: admin");
            }
            ...
            // ── 2. GENERAL COUNSELLOR (Career Coordinator) ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] GENERAL_COUNSELLOR: gc");
            }
            ...
            for (int i = 0; i < evaluators.length; i++) {
                ...
                userRepository.save(u);
                System.out.println("  [OK] EVALUATOR: " + evaluators[i][1]);
            }
            ...
            // ── 7. Tech Mentor (Pending Verification) ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] COUNSELLOR (Pending): tm");
            }
            ...
            // ── 8. Business Mentor (Pending Verification) ──
            {
                ...
                u.setPasswordHash(hashPassword("mentor123", salt));
                userRepository.save(u);
                System.out.println("  [OK] COUNSELLOR (Pending): bm");
            }
            ...
            // ── 9. Health Mentor (Verified/Active) ──
            {
                ...
                u.setPasswordHash(hashPassword("mentor123", salt));
                userRepository.save(u);
                System.out.println("  [OK] COUNSELLOR (Active): hm");
            }
            ...
            // ── 10. Arts Mentor (Verified/Active) ──
            {
                ...
                u.setPasswordHash(hashPassword("mentor123", salt));
                userRepository.save(u);
                System.out.println("  [OK] COUNSELLOR (Active): am");
            }
            ...
            // ── 11. Pending Student 1 ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] STUDENT (Pending): student1");
            }
            ...
            // ── 12. Pending Student 2 ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] STUDENT (Pending): student2");
            }
            ...
            // ── 13. Aman Agarwal (Pending) ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] STUDENT (Pending): amanagarwal0602");
            }
            ...
            // ── 14. Aman (Pending) ──
            {
                ...
                u.setPasswordHash(hashPassword("aman123", salt));
                userRepository.save(u);
                System.out.println("  [OK] STUDENT (Pending): aman");
            }
            ...
            // ── 15. Demo Student (Full profile - Already Active) ──
            {
                ...
                userRepository.save(u);
                System.out.println("  [OK] STUDENT: ds");
            }
